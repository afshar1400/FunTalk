    ...
    public partial class InitialAll : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    UserId = table.Column<string>(type: "TEXT", nullable: true),
                    JokeId = table.Column<long>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MainCmts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MainCmts_Jokes_JokeId",
                        column: x => x.JokeId,
                        principalTable: "Jokes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    MainCmt = table.Column<long>(type: "INTEGER", nullable: false),
                    MainCmtId = table.Column<long>(type: "INTEGER", nullable: true),
                    JokeId = table.Column<long>(type: "INTEGER", nullable: false),
                    Comment = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    UserId = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    Created = table.Column<DateTime>(type: "TEXT", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubCmts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubCmts_Jokes_JokeId",
                        column: x => x.JokeId,
                        principalTable: "Jokes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubCmts_MainCmts_MainCmtId",
                        column: x => x.MainCmtId,
                        principalTable: "MainCmts",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MainCmts_JokeId",
                table: "MainCmts",
                column: "JokeId");

            migrationBuilder.CreateIndex(
                name: "IX_SubCmts_JokeId",
                table: "SubCmts",
                column: "JokeId");

            migrationBuilder.CreateIndex(
                name: "IX_SubCmts_MainCmtId",
                table: "SubCmts",
                column: "MainCmtId");
        }
